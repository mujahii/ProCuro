...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col" style={{ height: 'calc(100vh - 8.5rem)' }}>
      ...
      {ownerProfileModal && (
        <OwnerProfileModal
          ownerId={ownerProfileModal.id}
          onClose={() => setOwnerProfileModal(null)}
      ...
      {supplierProfileModal && (
        <SupplierProfileModal
          supplierId={supplierProfileModal.id}
          businessName={supplierProfileModal.business_name}
          onClose={() => setSupplierProfileModal(null)}
        />
      )}
    </div>
  )
