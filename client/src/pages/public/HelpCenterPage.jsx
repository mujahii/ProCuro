      ...
      <main className="max-w-2xl mx-auto px-4 py-12 flex-grow w-full">
        ...
        {sent ? (
          <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-8 text-center">
            ...
            <h2 className="font-bold text-emerald-900 text-lg mb-1">Message sent!</h2>
            <p className="text-sm text-emerald-700">Your email client should have opened. If not, email us directly at <strong>support@procuro.com</strong></p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-4">
            ...
            <p className="text-xs text-slate-400 text-center">
              Or email us directly at <a href="mailto:support@procuro.com" className="text-emerald-600 font-semibold hover:underline">support@procuro.com</a>
            </p>
          </form>
        )}
      </main>
