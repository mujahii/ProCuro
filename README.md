...
**Last Updated:** 2026-05-21 22:25 (MYT — Kuala Lumpur)
...
| UsersPage | `/admin/users` | List all users; ban/unban; delete; view details; deleted accounts log. Per-row actions (View, Chat, Send Notification, Toggle Listing, Reset Password, Ban/Unban, Delete) are collapsed into a single **⋮ menu** to prevent mobile viewport overflow. |
