      ...
      <section className="relative min-h-[600px] sm:min-h-[640px] flex flex-col overflow-hidden" style={{ background: '#052532' }}>
        <style>{`
          ...
          .rise-blob {
            ...
            animation: riseBlobMobile 28s linear infinite;
          }
          @media (min-width: 640px) {
            .rise-blob { animation: riseBlob 15s linear infinite; }
          }
        `}</style>

        {/* Rising brand-colour orbs — mobile: medium (w-40–48); desktop: large (sm:w-[18rem]–[26rem]) */}
        {/* Marigold / warm gold — far left */}
        <div className="rise-blob absolute left-[4%] top-0 w-44 h-44 sm:w-[26rem] sm:h-[26rem] rounded-full pointer-events-none blur-[44px] sm:blur-[80px]"
          style={{ background: '#A58D66', animationDelay: '0s' }} />
        {/* Celeste / light teal — right-center */}
        <div className="rise-blob absolute left-[54%] top-0 w-40 h-40 sm:w-[22rem] sm:h-[22rem] rounded-full pointer-events-none blur-[40px] sm:blur-[72px]"
          style={{ background: '#C0D5D6', animationDelay: '-7s' }} />
        {/* Herb / mid teal-green — center */}
        <div className="rise-blob absolute left-[28%] top-0 w-36 h-36 sm:w-[20rem] sm:h-[20rem] rounded-full pointer-events-none blur-[36px] sm:blur-[64px]"
          style={{ background: '#5E96A4', animationDelay: '-14s' }} />
        {/* Lionsmane / warm cream — far right */}
        <div className="rise-blob absolute left-[70%] top-0 w-40 h-40 sm:w-[24rem] sm:h-[24rem] rounded-full pointer-events-none blur-[40px] sm:blur-[80px]"
          style={{ background: '#BFA988', animationDelay: '-21s' }} />
        {/* Rose / soft mauve — left-center */}
        <div className="rise-blob absolute left-[40%] top-0 w-32 h-32 sm:w-[18rem] sm:h-[18rem] rounded-full pointer-events-none blur-[32px] sm:blur-[60px]"
          style={{ background: '#B07B8B', animationDelay: '-4s' }} />
        {/* Light purple / lavender — far right edge */}
        <div className="rise-blob absolute left-[82%] top-0 w-36 h-36 sm:w-[22rem] sm:h-[22rem] rounded-full pointer-events-none blur-[36px] sm:blur-[70px]"
          style={{ background: '#B19CD9', animationDelay: '-11s' }} />
        ...
        <section className="py-4 sm:py-8 text-center border-t border-slate-100">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-stretch max-w-2xl mx-auto w-full px-4">
            ...
            <button
              ...
              className="flex items-center gap-3 bg-white text-slate-900 px-5 py-3.5 rounded-xl hover:bg-slate-50 active:scale-95 transition-all border border-slate-200 shadow-sm flex-1 justify-center"
            >
              ...
              <div className="text-left">
                <div className="text-[9px] text-slate-400 leading-none mb-0.5">{t('mobileDownloadOn')}</div>
                <div className="text-[14px] font-semibold leading-none text-slate-900">App Store</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-[9px] text-slate-400 leading-none mb-0.5">{t('mobileGetItOn')}</div>
                <div className="text-[14px] font-semibold leading-none text-slate-900">Google Play</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-[9px] text-slate-400 leading-none mb-0.5">{t('mobileExploreOn')}</div>
                <div className="text-[14px] font-semibold leading-none text-slate-900">AppGallery</div>
              </div>
            </button>
      ...
      {showComingSoon && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setShowComingSoon(false)}
              className="w-full bg-midnight text-white py-3 rounded-xl font-bold text-sm hover:bg-midnight-dark transition-colors"
            >
              OK
            </button>
          </div>
