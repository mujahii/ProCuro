    ...
    <div className="min-h-screen bg-slate-50 flex flex-col pt-16">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 flex-grow w-full">
          ...
          <div className="grid grid-cols-3 gap-4 mt-5">
            {[
              ...
              <div key={stat.label} className="text-center p-3 bg-slate-50 rounded-xl">
                <p className="text-xl font-black text-emerald-600">{stat.value}</p>
        ...
        <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6 mb-6">
          <h2 className="font-bold text-emerald-900 mb-2">Press Contact</h2>
          <p className="text-sm text-emerald-800 mb-3">For press inquiries, interview requests, or media assets, please reach out to our team.</p>
          <a
            href="mailto:support@procuro.com?subject=Press Inquiry"
            className="inline-flex items-center gap-2 bg-emerald-600 text-white text-sm font-bold px-4 py-2.5 rounded-xl hover:bg-emerald-700 transition-colors"
          >
