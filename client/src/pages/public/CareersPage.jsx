    ...
    <div className="min-h-screen bg-lionsmane flex flex-col pt-16">
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 flex-grow w-full">
        ...
        <div className="bg-lionsmane border border-celeste rounded-2xl p-6 mb-8">
          <h2 className="font-bold text-midnight mb-1">Why ProCuro?</h2>
          ...
          {OPENINGS.map(job => (
            <div key={job.title} className="bg-white rounded-xl border border-slate-100 shadow-sm p-5">
              <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                ...
                <span className="text-xs font-semibold bg-celeste text-midnight-dark px-2.5 py-1 rounded-full">{job.type}</span>
              </div>
