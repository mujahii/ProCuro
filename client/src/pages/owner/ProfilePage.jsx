    ...
    <div className="max-w-lg mx-auto space-y-4 py-4">
      ...
      <div className="card overflow-hidden">
        ...
        <div className="px-8 pb-7 text-center -mt-14">
          ...
          <h2 className="font-bold text-midnight text-xl mt-3">{displayName || t('restaurantOwner')}</h2>
        ...
        <div className="divide-y divide-slate-50">
          ...
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              {businessInfo.restaurant_name ? (
                <p className="text-sm font-semibold text-midnight mt-0.5">{businessInfo.restaurant_name}</p>
              ) : (
          ...
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              {businessInfo.tax_id ? (
                <p className="text-sm font-semibold text-midnight mt-0.5">{businessInfo.tax_id}</p>
              ) : (
                <button onClick={() => setShowBusinessInfoModal(true)} className="text-sm text-marigold font-semibold hover:underline mt-0.5">
                  {t('addTaxId')} →
                </button>
